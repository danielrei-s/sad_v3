...
namespace WindowsFormsApp1
{
    ...
    public partial class ODS_form : Form
    {
        ...
        private void seguinte_btn_Click(object sender, EventArgs e)
        {
            ...
            //SqlConnection conn = new SqlConnection("Data Source=LENOVO-CARBON\\SQLEXPRESS;Initial Catalog=SAD_DB;Integrated Security=True");
            conn.Open();
            ...
            if (NUT != "") {
                 query1 += "where "+ NUT.Substring(0, 10);
            }
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    {
                        if (((int)reader.GetSqlInt32(x)) >= valorODS)
                        {
                            row[x] = true;
                        }
                        else
                ...
                MessageBox.Show("exceptio sql Load Values Apriori");
            }
           ...
           Apriori myApriori = new Apriori(new DataFields(odsSelection, Rows));
            ...
            for (int a=resultado.Count-1; a >= 0; a--) {
                ...
                listBox1.Items.Add("Projetos com os ODS - "+resultado.ElementAt(a));
                try
                {
                    ...
                    while (reader1.Read())
                    {
                        listBox1.Items.Add(reader1["ID"] + " - " + reader1["projeto"] + " - " + reader1["Municipio"] );
        ...
        {
            if (!(listBox1.SelectedItem.ToString().StartsWith("P"))) {
